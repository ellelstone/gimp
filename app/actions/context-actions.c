...
{
  { "context-foreground-hue-set", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Hue Set", NULL, NULL,
    GIMP_ACTION_SELECT_SET, TRUE,
    NULL },
  { "context-foreground-hue-minimum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Hue Minimum", NULL, NULL,
    GIMP_ACTION_SELECT_FIRST, FALSE,
    NULL },
  { "context-foreground-hue-maximum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Hue Maximum", NULL, NULL,
    GIMP_ACTION_SELECT_LAST, FALSE,
    NULL },
  { "context-foreground-hue-decrease", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Hue Decrease", NULL, NULL,
    GIMP_ACTION_SELECT_PREVIOUS, FALSE,
    NULL },
  { "context-foreground-hue-increase", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Hue Increase", NULL, NULL,
    GIMP_ACTION_SELECT_NEXT, FALSE,
    NULL },
  { "context-foreground-hue-decrease-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Hue Decrease 10%", NULL, NULL,
    GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    NULL },
  { "context-foreground-hue-increase-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
...
{
  { "context-foreground-saturation-set", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Saturation Set", NULL, NULL,
    GIMP_ACTION_SELECT_SET, TRUE,
    NULL },
  { "context-foreground-saturation-minimum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Saturation Minimum", NULL, NULL,
    GIMP_ACTION_SELECT_FIRST, FALSE,
    NULL },
  { "context-foreground-saturation-maximum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Saturation Maximum", NULL, NULL,
    GIMP_ACTION_SELECT_LAST, FALSE,
    NULL },
  { "context-foreground-saturation-decrease", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Saturation Decrease", NULL, NULL,
    GIMP_ACTION_SELECT_PREVIOUS, FALSE,
    NULL },
  { "context-foreground-saturation-increase", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Saturation Increase", NULL, NULL,
    GIMP_ACTION_SELECT_NEXT, FALSE,
    NULL },
  { "context-foreground-saturation-decrease-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Saturation Decrease 10%", NULL, NULL,
    GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    NULL },
  { "context-foreground-saturation-increase-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
...
{
  { "context-foreground-value-set", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Value Set", NULL, NULL,
    GIMP_ACTION_SELECT_SET, TRUE,
    NULL },
  { "context-foreground-value-minimum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Value Minimum", NULL, NULL,
    GIMP_ACTION_SELECT_FIRST, FALSE,
    NULL },
  { "context-foreground-value-maximum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Value Maximum", NULL, NULL,
    GIMP_ACTION_SELECT_LAST, FALSE,
    NULL },
  { "context-foreground-value-decrease", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Value Decrease", NULL, NULL,
    GIMP_ACTION_SELECT_PREVIOUS, FALSE,
    NULL },
  { "context-foreground-value-increase", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Value Increase", NULL, NULL,
    GIMP_ACTION_SELECT_NEXT, FALSE,
    NULL },
  { "context-foreground-value-decrease-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Foreground Value Decrease 10%", NULL, NULL,
    GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    NULL },
  { "context-foreground-value-increase-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
...
{
  { "context-background-hue-set", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Hue Set", NULL, NULL,
    GIMP_ACTION_SELECT_SET, TRUE,
    NULL },
  { "context-background-hue-minimum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Hue Minimum", NULL, NULL,
    GIMP_ACTION_SELECT_FIRST, FALSE,
    NULL },
  { "context-background-hue-maximum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Hue Maximum", NULL, NULL,
    GIMP_ACTION_SELECT_LAST, FALSE,
    NULL },
  { "context-background-hue-decrease", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Hue Decrease", NULL, NULL,
    GIMP_ACTION_SELECT_PREVIOUS, FALSE,
    NULL },
  { "context-background-hue-increase", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Hue Increase", NULL, NULL,
    GIMP_ACTION_SELECT_NEXT, FALSE,
    NULL },
  { "context-background-hue-decrease-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Hue Decrease 10%", NULL, NULL,
    GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    NULL },
  { "context-background-hue-increase-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
...
{
  { "context-background-saturation-set", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Saturation Set", NULL, NULL,
    GIMP_ACTION_SELECT_SET, TRUE,
    NULL },
  { "context-background-saturation-minimum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Saturation Minimum", NULL, NULL,
    GIMP_ACTION_SELECT_FIRST, FALSE,
    NULL },
  { "context-background-saturation-maximum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Saturation Maximum", NULL, NULL,
    GIMP_ACTION_SELECT_LAST, FALSE,
    NULL },
  { "context-background-saturation-decrease", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Saturation Decrease", NULL, NULL,
    GIMP_ACTION_SELECT_PREVIOUS, FALSE,
    NULL },
  { "context-background-saturation-increase", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Saturation Increase", NULL, NULL,
    GIMP_ACTION_SELECT_NEXT, FALSE,
    NULL },
  { "context-background-saturation-decrease-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Saturation Decrease 10%", NULL, NULL,
    GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    NULL },
  { "context-background-saturation-increase-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
...
{
  { "context-background-value-set", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Value Set", NULL, NULL,
    GIMP_ACTION_SELECT_SET, TRUE,
    NULL },
  { "context-background-value-minimum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Value Minimum", NULL, NULL,
    GIMP_ACTION_SELECT_FIRST, FALSE,
    NULL },
  { "context-background-value-maximum", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Value Maximum", NULL, NULL,
    GIMP_ACTION_SELECT_LAST, FALSE,
    NULL },
  { "context-background-value-decrease", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Value Decrease", NULL, NULL,
    GIMP_ACTION_SELECT_PREVIOUS, FALSE,
    NULL },
  { "context-background-value-increase", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Value Increase", NULL, NULL,
    GIMP_ACTION_SELECT_NEXT, FALSE,
    NULL },
  { "context-background-value-decrease-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
    "Background Value Decrease 10%", NULL, NULL,
    GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    NULL },
  { "context-background-value-increase-skip", GIMP_STOCK_TOOL_HUE_CHROMA,
