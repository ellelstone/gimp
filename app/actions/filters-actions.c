...
static const GimpActionEntry filters_menu_actions[] =
{
  ...
  { "filters-map-menu",             NULL, NC_("filters-action",
                                              "_Map")              },
  { "filters-patterns-menu",          NULL, NC_("filters-action",
                                              "_Patterns")           },
  { "filters-patterns-clouds-menu",   NULL, NC_("filters-action",
                                              "_Clouds")           },
  { "filters-patterns-fractals-menu", NULL, NC_("filters-action",
                                              "_Fractals")         },
  { "filters-patterns-nature-menu",   NULL, NC_("filters-action",
                                              "_Nature")           },
  { "filters-patterns-noise-menu",    NULL, NC_("filters-action",
                                              "N_oise")            },
  { "filters-patterns-pattern-menu",  NULL, NC_("filters-action",
                                              "_Pattern")          },
