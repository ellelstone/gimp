...
static const GimpRadioActionEntry view_zoom_explicit_actions[] =
{
  ...
  { "view-zoom-4-5", NULL,
    NC_("view-zoom-action", "4:_5  (80%)"), "<shift>2",
    NC_("view-zoom-action", "Zoom 4:5"),
    8000,
    GIMP_HELP_VIEW_ZOOM_OUT },

  { "view-zoom-2-3", NULL,
    NC_("view-zoom-action", "2:_3  (66.67%)"), "<shift>2",
    NC_("view-zoom-action", "Zoom 2:3"),
    6667,
    GIMP_HELP_VIEW_ZOOM_OUT },
  ...
  { "view-zoom-1-3", NULL,
    NC_("view-zoom-action", "1:_3  (33.33%)"), "<shift>3",
    NC_("view-zoom-action", "Zoom 1:3"),
    3333,
    GIMP_HELP_VIEW_ZOOM_OUT },

  { "view-zoom-1-4", NULL,
    NC_("view-zoom-action", "1:_4  (25%)"), "<shift>4",
    NC_("view-zoom-action", "Zoom 1:4"),
    2500,
    GIMP_HELP_VIEW_ZOOM_OUT },

  { "view-zoom-1-5", NULL,
    NC_("view-zoom-action", "1:_5  (20%)"), "<shift>5",
    NC_("view-zoom-action", "Zoom 1:5"),
    2000,
    GIMP_HELP_VIEW_ZOOM_OUT },

  { "view-zoom-1-8", NULL,
    NC_("view-zoom-action", "1:_8  (12.5%)"), "<shift>6",
    NC_("view-zoom-action", "Zoom 1:8"),
    1250,
    GIMP_HELP_VIEW_ZOOM_OUT },

  { "view-zoom-1-10", NULL,
    NC_("view-zoom-action", "1:1_0  (10%)"), "<shift>7",
    NC_("view-zoom-action", "Zoom 1:10"),
    1000,
    GIMP_HELP_VIEW_ZOOM_OUT },

  { "view-zoom-1-16", NULL,
    NC_("view-zoom-action", "1:1_6  (6.25%)"), "<shift>8",
