...
#define GIMP_HUE_MODE           GIMP_LAYER_MODE_HSV_HUE
#define GIMP_SATURATION_MODE    GIMP_LAYER_MODE_HSV_SATURATION
#define GIMP_COLOR_MODE         GIMP_LAYER_MODE_HSV_COLOR
#define GIMP_VALUE_MODE         GIMP_LAYER_MODE_HSV_VALUE
