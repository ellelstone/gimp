...
decompose (gint32       image_ID,
           ...
           gint32      *nlayers,
           gint32      *layer_ID_dst)
{//printf("4. decompose.c decompose\n");
  const gchar   *layername;
  gint           j, extract_idx;
...
create_new_image (const gchar       *filename,
                  ...
                  gdouble            yres,
                  gint32            *layer_ID)
{//printf("6. decompose.c create_new_image\n");
  gint32 image_ID;
...
create_new_layer (gint32             image_ID,
                  ...
                  guint              height,
                  GimpImageBaseType  type)
{//printf("7. decompose.c create_new_layer\n");
  gint32        layer_ID;
...
cpn_affine_transform_clamp (GeglBuffer *buffer,
                            ...
                            gdouble     max,
                            gboolean    clamp)
{//printf("?? decompose.c cpn_affine_transform_clamp\n");
  GeglBufferIterator *gi;
...
copy_n_components (GeglBuffer  *src,
                   GeglBuffer **dst,
                   Extract      ext)
{//printf("8. decompose.c copy_n_components\n");
...
copy_one_component (GeglBuffer      *src,
                    ...
                    const Component  component,
                    gboolean         clamp)
{//printf("9. decompose.c copy_one_component\n");
...
{//printf("3. decompose.c decompose_dialog\n");
  GtkWidget *dialog;
  GtkWidget *main_vbox;
  GtkWidget *frame;
  GtkWidget *vbox;
...
generate_filename (guint32 image_ID,
                   guint   colorspace,
                   guint   channel)
{//printf("5. decompose.c generate_filename\n");
  /* Build a filename like <imagename>-<channel>.<extension> */
  gchar   *fname;
  gchar   *filename;
  gchar   *extension;
