...
layermodes_map = {
    ...
    "svg:multiply": LAYER_MODE_MULTIPLY,
    "svg:screen": LAYER_MODE_SCREEN,
    "svg:overlay": LAYER_MODE_OVERLAY,
    "svg:darken": LAYER_MODE_DARKEN_ONLY,
    "svg:lighten": LAYER_MODE_LIGHTEN_ONLY,
    "svg:color-dodge": LAYER_MODE_DODGE,
    "svg:color-burn": LAYER_MODE_BURN,
    "svg:hard-light": LAYER_MODE_HARDLIGHT,
    "svg:soft-light": LAYER_MODE_SOFTLIGHT,
    "svg:difference": LAYER_MODE_DIFFERENCE,
    "svg:color": LAYER_MODE_HSL_COLOR,
    "svg:luminosity": LAYER_MODE_HSV_VALUE,
    "svg:hue": LAYER_MODE_HSV_HUE,
    "svg:saturation": LAYER_MODE_HSV_SATURATION,
    "svg:plus": LAYER_MODE_ADDITION,
}
