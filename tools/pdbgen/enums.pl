...
%enums = (
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL => '0',
		       ...
		       GIMP_LAYER_MODE_DIVIDE => '16',
		       GIMP_LAYER_MODE_DODGE => '17',
		       GIMP_LAYER_MODE_BURN => '18',
		       GIMP_LAYER_MODE_HARDLIGHT => '19',
		       GIMP_LAYER_MODE_SOFTLIGHT => '20',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '21',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '22',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '23',
		       GIMP_LAYER_MODE_PIN_LIGHT => '24',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '25',
		       GIMP_LAYER_MODE_HARD_MIX => '26',
		       GIMP_LAYER_MODE_EXCLUSION => '27',
		       GIMP_LAYER_MODE_LINEAR_BURN => '28',
		       GIMP_LAYER_MODE_LUMA_DARKEN_ONLY => '29',
		       GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY => '30' }
	},
