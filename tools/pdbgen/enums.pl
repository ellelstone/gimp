...
%enums = (
	...
	{ contig => 1,
	  ...
	  symbols => [ qw(GIMP_SELECT_CRITERION_COMPOSITE
			  ...
			  GIMP_SELECT_CRITERION_B GIMP_SELECT_CRITERION_L
			  GIMP_SELECT_CRITERION_C GIMP_SELECT_CRITERION_H
	  ...
	  mapping => { GIMP_SELECT_CRITERION_COMPOSITE => '0',
		       ...
		       GIMP_SELECT_CRITERION_L => '4',
		       GIMP_SELECT_CRITERION_C => '5',
		       GIMP_SELECT_CRITERION_H => '6',
	...
	{ contig => 1,
	  ...
	  symbols => [ qw(GIMP_NORMAL_MODE GIMP_DISSOLVE_MODE
			  ...
			  GIMP_LIGHTEN_ONLY_MODE GIMP_DIVIDE_MODE
			  ...
			  GIMP_LCH_LIGHTNESS_MODE GIMP_LUMINANCE_MODE) ],
	  mapping => { GIMP_NORMAL_MODE => '0',
		       ...
		       GIMP_DODGE_MODE => '12',
		       GIMP_BURN_MODE => '13',
		       GIMP_HARDLIGHT_MODE => '14',
		       GIMP_SOFTLIGHT_MODE => '15',
		       GIMP_GRAIN_EXTRACT_MODE => '16',
		       GIMP_GRAIN_MERGE_MODE => '17',
		       GIMP_COLOR_ERASE_MODE => '18',
		       GIMP_NEW_OVERLAY_MODE => '19',
		       GIMP_LCH_HUE_MODE => '20',
		       GIMP_LCH_CHROMA_MODE => '21',
		       GIMP_LCH_COLOR_MODE => '22',
		       GIMP_LCH_LIGHTNESS_MODE => '23',
		       GIMP_LUMINANCE_MODE => '24' }
	},
