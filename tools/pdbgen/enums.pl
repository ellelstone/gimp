...
%enums = (
	...
	{ contig => 1,
	  ...
	  symbols => [ qw(GIMP_LAYER_MODE_NORMAL GIMP_LAYER_MODE_DISSOLVE
			  ...
			  GIMP_LAYER_MODE_LUMINANCE GIMP_LAYER_MODE_ERASE
			  GIMP_LAYER_MODE_MERGE GIMP_LAYER_MODE_SPLIT) ],
	  mapping => { GIMP_LAYER_MODE_NORMAL => '0',
		       GIMP_LAYER_MODE_DISSOLVE => '1',
		       GIMP_LAYER_MODE_COLOR_ERASE => '2',
		       GIMP_LAYER_MODE_OVERLAY => '3',
		       GIMP_LAYER_MODE_LCH_HUE => '4',
		       GIMP_LAYER_MODE_LCH_CHROMA => '5',
		       GIMP_LAYER_MODE_LCH_COLOR => '6',
		       GIMP_LAYER_MODE_LCH_LIGHTNESS => '7',
		       GIMP_LAYER_MODE_BEHIND => '8',
		       GIMP_LAYER_MODE_MULTIPLY => '9',
		       GIMP_LAYER_MODE_SCREEN => '10',
		       GIMP_LAYER_MODE_DIFFERENCE => '11',
		       GIMP_LAYER_MODE_ADDITION => '12',
		       GIMP_LAYER_MODE_SUBTRACT => '13',
		       GIMP_LAYER_MODE_DARKEN_ONLY => '14',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '15',
		       GIMP_LAYER_MODE_HSV_HUE => '16',
		       GIMP_LAYER_MODE_HSV_SATURATION => '17',
		       GIMP_LAYER_MODE_HSL_COLOR => '18',
		       GIMP_LAYER_MODE_HSV_VALUE => '19',
		       GIMP_LAYER_MODE_DIVIDE => '20',
		       GIMP_LAYER_MODE_DODGE => '21',
		       GIMP_LAYER_MODE_BURN => '22',
		       GIMP_LAYER_MODE_HARDLIGHT => '23',
		       GIMP_LAYER_MODE_SOFTLIGHT => '24',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '25',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '26',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '27',
		       GIMP_LAYER_MODE_PIN_LIGHT => '28',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '29',
		       GIMP_LAYER_MODE_HARD_MIX => '30',
		       GIMP_LAYER_MODE_EXCLUSION => '31',
		       GIMP_LAYER_MODE_LINEAR_BURN => '32',
		       GIMP_LAYER_MODE_LUMA_DARKEN_ONLY => '33',
		       GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY => '34',
		       GIMP_LAYER_MODE_LUMINANCE => '35',
