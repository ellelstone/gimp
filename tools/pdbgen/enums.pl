...
%enums = (
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL => '0',
		       ...
		       GIMP_LAYER_MODE_DIVIDE => '24',
		       GIMP_LAYER_MODE_DIVIDE_LINEAR => '25',
		       GIMP_LAYER_MODE_DODGE => '26',
		       GIMP_LAYER_MODE_DODGE_LINEAR => '27',
		       GIMP_LAYER_MODE_BURN => '28',
		       GIMP_LAYER_MODE_BURN_LINEAR => '29',
		       GIMP_LAYER_MODE_HARDLIGHT => '30',
		       GIMP_LAYER_MODE_HARDLIGHT_LINEAR => '31',
		       GIMP_LAYER_MODE_SOFTLIGHT => '32',
		       GIMP_LAYER_MODE_SOFTLIGHT_LINEAR => '33',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '34',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT_LINEAR => '35',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '36',
		       GIMP_LAYER_MODE_GRAIN_MERGE_LINEAR => '37',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '38',
		       GIMP_LAYER_MODE_VIVID_LIGHT_LINEAR => '39',
		       GIMP_LAYER_MODE_PIN_LIGHT => '40',
		       GIMP_LAYER_MODE_PIN_LIGHT_LINEAR => '41',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '42',
		       GIMP_LAYER_MODE_LINEAR_LIGHT_LINEAR => '43',
		       GIMP_LAYER_MODE_HARD_MIX => '44',
		       GIMP_LAYER_MODE_HARD_MIX_LINEAR => '45',
		       GIMP_LAYER_MODE_EXCLUSION => '46',
		       GIMP_LAYER_MODE_EXCLUSION_LINEAR => '47',
		       GIMP_LAYER_MODE_LINEAR_BURN => '48',
		       GIMP_LAYER_MODE_LINEAR_BURN_LINEAR => '49',
		       GIMP_LAYER_MODE_LUMA_DARKEN_ONLY => '50',
		       GIMP_LAYER_MODE_LUMINANCE_DARKEN_ONLY => '51',
		       GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY => '52',
		       GIMP_LAYER_MODE_LUMINANCE_LIGHTEN_ONLY => '53' }
	},
