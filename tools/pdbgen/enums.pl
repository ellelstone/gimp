...
%enums = (
	...
	{ contig => 1,
	  ...
	  symbols => [ qw(GIMP_LAYER_MODE_NORMAL_NON_LINEAR
			  ...
			  GIMP_LAYER_MODE_LUMINANCE GIMP_LAYER_MODE_NORMAL
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL_NON_LINEAR => '0',
		       ...
		       GIMP_LAYER_MODE_LUMINANCE => '9',
		       GIMP_LAYER_MODE_NORMAL => '10',
		       GIMP_LAYER_MODE_BEHIND_LINEAR => '11',
		       GIMP_LAYER_MODE_MULTIPLY => '12',
		       GIMP_LAYER_MODE_MULTIPLY_LINEAR => '13',
		       GIMP_LAYER_MODE_SCREEN => '14',
		       GIMP_LAYER_MODE_SCREEN_LINEAR => '15',
		       GIMP_LAYER_MODE_OVERLAY_LINEAR => '16',
		       GIMP_LAYER_MODE_DIFFERENCE => '17',
		       GIMP_LAYER_MODE_DIFFERENCE_LINEAR => '18',
		       GIMP_LAYER_MODE_ADDITION => '19',
		       GIMP_LAYER_MODE_ADDITION_LINEAR => '20',
		       GIMP_LAYER_MODE_SUBTRACT => '21',
		       GIMP_LAYER_MODE_SUBTRACT_LINEAR => '22',
		       GIMP_LAYER_MODE_DARKEN_ONLY => '23',
		       GIMP_LAYER_MODE_DARKEN_ONLY_LINEAR => '24',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '25',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY_LINEAR => '26',
		       GIMP_LAYER_MODE_HSV_HUE => '27',
		       GIMP_LAYER_MODE_HSV_SATURATION => '28',
		       GIMP_LAYER_MODE_HSV_COLOR => '29',
		       GIMP_LAYER_MODE_HSV_VALUE => '30',
		       GIMP_LAYER_MODE_DIVIDE => '31',
		       GIMP_LAYER_MODE_DIVIDE_LINEAR => '32',
		       GIMP_LAYER_MODE_DODGE => '33',
		       GIMP_LAYER_MODE_DODGE_LINEAR => '34',
		       GIMP_LAYER_MODE_BURN => '35',
		       GIMP_LAYER_MODE_BURN_LINEAR => '36',
		       GIMP_LAYER_MODE_HARDLIGHT => '37',
		       GIMP_LAYER_MODE_HARDLIGHT_LINEAR => '38',
		       GIMP_LAYER_MODE_SOFTLIGHT => '39',
		       GIMP_LAYER_MODE_SOFTLIGHT_LINEAR => '40',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '41',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT_LINEAR => '42',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '43',
		       GIMP_LAYER_MODE_GRAIN_MERGE_LINEAR => '44' }
	},
