...
%enums = (
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL => '0',
		       ...
		       GIMP_LAYER_MODE_BEHIND_LINEAR => '30',
		       GIMP_LAYER_MODE_MULTIPLY => '31',
		       GIMP_LAYER_MODE_MULTIPLY_LINEAR => '32',
		       GIMP_LAYER_MODE_SCREEN => '33',
		       GIMP_LAYER_MODE_SCREEN_LINEAR => '34',
		       GIMP_LAYER_MODE_OVERLAY_LINEAR => '35',
		       GIMP_LAYER_MODE_DIFFERENCE => '36',
		       GIMP_LAYER_MODE_DIFFERENCE_LINEAR => '37',
		       GIMP_LAYER_MODE_ADDITION => '38',
		       GIMP_LAYER_MODE_ADDITION_LINEAR => '39',
		       GIMP_LAYER_MODE_SUBTRACT => '40',
		       GIMP_LAYER_MODE_SUBTRACT_LINEAR => '41',
		       GIMP_LAYER_MODE_DARKEN_ONLY => '42',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '43',
		       GIMP_LAYER_MODE_HSV_HUE => '44',
		       GIMP_LAYER_MODE_HSV_SATURATION => '45',
		       GIMP_LAYER_MODE_HSV_COLOR => '46',
		       GIMP_LAYER_MODE_HSV_VALUE => '47',
		       GIMP_LAYER_MODE_DIVIDE => '48',
		       GIMP_LAYER_MODE_DIVIDE_LINEAR => '49',
		       GIMP_LAYER_MODE_DODGE => '50',
		       GIMP_LAYER_MODE_DODGE_LINEAR => '51',
		       GIMP_LAYER_MODE_BURN => '52',
		       GIMP_LAYER_MODE_BURN_LINEAR => '53',
		       GIMP_LAYER_MODE_HARDLIGHT => '54',
		       GIMP_LAYER_MODE_HARDLIGHT_LINEAR => '55',
		       GIMP_LAYER_MODE_SOFTLIGHT => '56',
		       GIMP_LAYER_MODE_SOFTLIGHT_LINEAR => '57',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '58',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT_LINEAR => '59',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '60',
		       GIMP_LAYER_MODE_GRAIN_MERGE_LINEAR => '61',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '62',
		       GIMP_LAYER_MODE_VIVID_LIGHT_LINEAR => '63',
		       GIMP_LAYER_MODE_PIN_LIGHT => '64',
		       GIMP_LAYER_MODE_PIN_LIGHT_LINEAR => '65',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '66',
		       GIMP_LAYER_MODE_LINEAR_LIGHT_LINEAR => '67',
		       GIMP_LAYER_MODE_EXCLUSION => '68',
		       GIMP_LAYER_MODE_EXCLUSION_LINEAR => '69',
		       GIMP_LAYER_MODE_LINEAR_BURN => '70',
		       GIMP_LAYER_MODE_LINEAR_BURN_LINEAR => '71' }
	},
