...
%enums = (
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL_NON_LINEAR => '0',
		       ...
		       GIMP_LAYER_MODE_DARKEN_ONLY_LINEAR => '43',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '44',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY_LINEAR => '45',
		       GIMP_LAYER_MODE_HSV_HUE => '46',
		       GIMP_LAYER_MODE_HSV_SATURATION => '47',
		       GIMP_LAYER_MODE_HSV_COLOR => '48',
		       GIMP_LAYER_MODE_HSV_VALUE => '49',
		       GIMP_LAYER_MODE_DIVIDE => '50',
		       GIMP_LAYER_MODE_DIVIDE_LINEAR => '51',
		       GIMP_LAYER_MODE_DODGE => '52',
		       GIMP_LAYER_MODE_DODGE_LINEAR => '53',
		       GIMP_LAYER_MODE_BURN => '54',
		       GIMP_LAYER_MODE_BURN_LINEAR => '55',
		       GIMP_LAYER_MODE_HARDLIGHT => '56',
		       GIMP_LAYER_MODE_HARDLIGHT_LINEAR => '57',
		       GIMP_LAYER_MODE_SOFTLIGHT => '58',
		       GIMP_LAYER_MODE_SOFTLIGHT_LINEAR => '59',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '60',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT_LINEAR => '61',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '62',
		       GIMP_LAYER_MODE_GRAIN_MERGE_LINEAR => '63' }
	},
