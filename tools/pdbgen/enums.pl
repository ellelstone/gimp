...
%enums = (
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_COLOR_SPACE_AUTO => '0',
		       GIMP_LAYER_COLOR_SPACE_RGB_PERCEPTUAL => '1' }
	},
	...
	{ contig => 1,
	  header => 'operations/operations-enums.h',
	  symbols => [ qw(GIMP_LAYER_MODE_DISSOLVE GIMP_LAYER_MODE_OVERLAY
	  ...
	  mapping => { GIMP_LAYER_MODE_DISSOLVE => '0',
		       GIMP_LAYER_MODE_OVERLAY => '1',
		       GIMP_LAYER_MODE_LCH_HUE => '2',
		       GIMP_LAYER_MODE_LCH_CHROMA => '3',
		       GIMP_LAYER_MODE_LCH_COLOR => '4',
		       GIMP_LAYER_MODE_LCH_LIGHTNESS => '5',
		       GIMP_LAYER_MODE_NORMAL => '6',
		       GIMP_LAYER_MODE_BEHIND => '7',
		       GIMP_LAYER_MODE_MULTIPLY => '8',
		       GIMP_LAYER_MODE_SCREEN => '9',
		       GIMP_LAYER_MODE_DIFFERENCE => '10',
		       GIMP_LAYER_MODE_ADDITION => '11',
		       GIMP_LAYER_MODE_SUBTRACT => '12',
		       GIMP_LAYER_MODE_DARKEN_ONLY => '13',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '14',
		       GIMP_LAYER_MODE_HSV_HUE => '15',
		       GIMP_LAYER_MODE_HSV_SATURATION => '16',
		       GIMP_LAYER_MODE_HSL_COLOR => '17',
		       GIMP_LAYER_MODE_HSV_VALUE => '18',
		       GIMP_LAYER_MODE_DIVIDE => '19',
		       GIMP_LAYER_MODE_DODGE => '20',
		       GIMP_LAYER_MODE_BURN => '21',
		       GIMP_LAYER_MODE_HARDLIGHT => '22',
		       GIMP_LAYER_MODE_SOFTLIGHT => '23',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '24',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '25',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '26',
		       GIMP_LAYER_MODE_PIN_LIGHT => '27',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '28',
		       GIMP_LAYER_MODE_HARD_MIX => '29',
		       GIMP_LAYER_MODE_EXCLUSION => '30',
		       GIMP_LAYER_MODE_LINEAR_BURN => '31',
		       GIMP_LAYER_MODE_LUMA_DARKEN_ONLY => '32',
		       GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY => '33',
		       GIMP_LAYER_MODE_LUMINANCE => '34',
		       GIMP_LAYER_MODE_COLOR_ERASE => '35',
		       GIMP_LAYER_MODE_ERASE => '36',
		       GIMP_LAYER_MODE_MERGE => '37',
		       GIMP_LAYER_MODE_SPLIT => '38',
		       GIMP_LAYER_MODE_MONO_MIX => '39',
		       GIMP_LAYER_MODE_PASS_THROUGH => '40' }
	},
