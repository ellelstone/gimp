...
%enums = (
	...
	{ contig => 0,
	  ...
	  mapping => { GIMP_COMPONENT_TYPE_U8 => '150',
		       GIMP_COMPONENT_TYPE_U16 => '250',
		       GIMP_COMPONENT_TYPE_U32 => '350',
		       GIMP_COMPONENT_TYPE_HALF => '550',
		       GIMP_COMPONENT_TYPE_FLOAT => '650',
		       GIMP_COMPONENT_TYPE_DOUBLE => '750' }
	},
	...
	{ contig => 0,
	  header => 'libgimpbase/gimpbaseenums.h',
	  symbols => [ qw(GIMP_PRECISION_U8_GAMMA GIMP_PRECISION_U16_GAMMA
			  GIMP_PRECISION_U32_GAMMA GIMP_PRECISION_HALF_GAMMA
			  GIMP_PRECISION_FLOAT_GAMMA
			  GIMP_PRECISION_DOUBLE_GAMMA) ],
	  mapping => { GIMP_PRECISION_U8_GAMMA => '150',
	...
	{ contig => 1,
	  ...
	  symbols => [ qw(GIMP_SELECT_CRITERION_COMPOSITE
			  ...
			  GIMP_SELECT_CRITERION_C GIMP_SELECT_CRITERION_L
	  ...
	  mapping => { GIMP_SELECT_CRITERION_COMPOSITE => '0',
		       ...
		       GIMP_SELECT_CRITERION_C => '5',
		       GIMP_SELECT_CRITERION_L => '6',
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL => '0',
		       ...
		       GIMP_LAYER_MODE_COLOR_ERASE => '3',
		       GIMP_LAYER_MODE_OVERLAY => '4',
		       GIMP_LAYER_MODE_LCH_HUE => '5',
		       GIMP_LAYER_MODE_LCH_CHROMA => '6',
		       GIMP_LAYER_MODE_LCH_COLOR => '7',
		       GIMP_LAYER_MODE_LCH_LIGHTNESS => '8',
		       GIMP_LAYER_MODE_NORMAL_LINEAR => '9',
		       GIMP_LAYER_MODE_BEHIND_LINEAR => '10',
		       GIMP_LAYER_MODE_MULTIPLY => '11',
		       GIMP_LAYER_MODE_MULTIPLY_LINEAR => '12',
		       GIMP_LAYER_MODE_SCREEN => '13',
		       GIMP_LAYER_MODE_SCREEN_LINEAR => '14',
		       GIMP_LAYER_MODE_OVERLAY_LINEAR => '15',
		       GIMP_LAYER_MODE_DIFFERENCE => '16',
		       GIMP_LAYER_MODE_DIFFERENCE_LINEAR => '17',
		       GIMP_LAYER_MODE_ADDITION => '18',
		       GIMP_LAYER_MODE_ADDITION_LINEAR => '19',
		       GIMP_LAYER_MODE_SUBTRACT => '20',
		       GIMP_LAYER_MODE_SUBTRACT_LINEAR => '21',
		       GIMP_LAYER_MODE_DARKEN_ONLY => '22',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '23',
		       GIMP_LAYER_MODE_HSV_HUE => '24',
		       GIMP_LAYER_MODE_HSV_SATURATION => '25',
		       GIMP_LAYER_MODE_HSV_COLOR => '26',
		       GIMP_LAYER_MODE_HSV_VALUE => '27',
		       GIMP_LAYER_MODE_DIVIDE => '28',
		       GIMP_LAYER_MODE_DIVIDE_LINEAR => '29',
		       GIMP_LAYER_MODE_DODGE => '30',
		       GIMP_LAYER_MODE_DODGE_LINEAR => '31',
		       GIMP_LAYER_MODE_BURN => '32',
		       GIMP_LAYER_MODE_BURN_LINEAR => '33',
		       GIMP_LAYER_MODE_HARDLIGHT => '34',
		       GIMP_LAYER_MODE_HARDLIGHT_LINEAR => '35',
		       GIMP_LAYER_MODE_SOFTLIGHT => '36',
		       GIMP_LAYER_MODE_SOFTLIGHT_LINEAR => '37',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '38',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT_LINEAR => '39',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '40',
		       GIMP_LAYER_MODE_GRAIN_MERGE_LINEAR => '41',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '42',
		       GIMP_LAYER_MODE_VIVID_LIGHT_LINEAR => '43',
		       GIMP_LAYER_MODE_PIN_LIGHT => '44',
		       GIMP_LAYER_MODE_PIN_LIGHT_LINEAR => '45',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '46',
		       GIMP_LAYER_MODE_LINEAR_LIGHT_LINEAR => '47',
		       GIMP_LAYER_MODE_HARD_MIX => '48',
		       GIMP_LAYER_MODE_HARD_MIX_LINEAR => '49',
		       GIMP_LAYER_MODE_EXCLUSION => '50',
		       GIMP_LAYER_MODE_EXCLUSION_LINEAR => '51',
		       GIMP_LAYER_MODE_LINEAR_BURN => '52',
		       GIMP_LAYER_MODE_LINEAR_BURN_LINEAR => '53',
		       GIMP_LAYER_MODE_LUMA_DARKEN_ONLY => '54',
		       GIMP_LAYER_MODE_LUMINANCE_DARKEN_ONLY => '55',
		       GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY => '56',
		       GIMP_LAYER_MODE_LUMINANCE_LIGHTEN_ONLY => '57' }
	},
