...
%enums = (
	...
	{ contig => 1,
	  ...
	  mapping => { GIMP_LAYER_MODE_NORMAL => '0',
		       ...
		       GIMP_LAYER_MODE_MULTIPLY => '10',
		       GIMP_LAYER_MODE_SCREEN => '11',
		       GIMP_LAYER_MODE_DIFFERENCE => '12',
		       GIMP_LAYER_MODE_ADDITION => '13',
		       GIMP_LAYER_MODE_SUBTRACT => '14',
		       GIMP_LAYER_MODE_DARKEN_ONLY => '15',
		       GIMP_LAYER_MODE_LIGHTEN_ONLY => '16',
		       GIMP_LAYER_MODE_DIVIDE => '17',
		       GIMP_LAYER_MODE_DODGE => '18',
		       GIMP_LAYER_MODE_BURN => '19',
		       GIMP_LAYER_MODE_HARDLIGHT => '20',
		       GIMP_LAYER_MODE_SOFTLIGHT => '21',
		       GIMP_LAYER_MODE_GRAIN_EXTRACT => '22',
		       GIMP_LAYER_MODE_GRAIN_MERGE => '23',
		       GIMP_LAYER_MODE_VIVID_LIGHT => '24',
		       GIMP_LAYER_MODE_PIN_LIGHT => '25',
		       GIMP_LAYER_MODE_LINEAR_LIGHT => '26',
		       GIMP_LAYER_MODE_HARD_MIX => '27',
		       GIMP_LAYER_MODE_EXCLUSION => '28',
		       GIMP_LAYER_MODE_LINEAR_BURN => '29',
		       GIMP_LAYER_MODE_LUMA_DARKEN_ONLY => '30',
		       GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY => '31' }
	},
